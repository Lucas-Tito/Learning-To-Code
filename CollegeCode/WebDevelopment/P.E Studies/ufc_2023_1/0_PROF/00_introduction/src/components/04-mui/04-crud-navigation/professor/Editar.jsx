...
const Editar = () => {
    ...
    const [area_interesse, setarea_interesse] = useState({ es: false, al: false, ds: false, mc: false })
            ...
            axios.get("http://localhost:3001/professor/retrieve/" + id)
                .then(
                    (res) => {
                        ...
                        setarea_interesse(res.data.area_interesse)
                    }
                )
    ...
    const { es, al, ds, mc } = area_interesse
    ...
    const handleSubmit = (e) => {
        ...
        {
            nome, curso, titulacao, area_interesse
        }
        //axios.put('http://localhost:3001/students/' + params.id, updatedStudent)
        axios.put('http://localhost:3001/professor/update/' + id, updatedProfessor)
            .then(
                res => {
